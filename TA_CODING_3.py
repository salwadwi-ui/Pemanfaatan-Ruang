...
if st.session_state.current_page == "landing":
    ...
    with col_right:
        ...
        st.markdown("""
        <div style="background: linear-gradient(135deg, rgba(212,175,55,0.1) 0%, rgba(26,39,68,0.05) 100%); padding: 20px; border-radius: 8px; border: 1px solid #D4AF37;">
            <p style="margin: 0; font-weight: 600; color: #1a2744; font-size: 0.95rem;">📊 Status Kesesuaian RTRW</p>
            <p style="margin: 8px 0 0 0; color: #666; font-size: 0.85rem; line-height: 1.6;">
                Sistem ini menampilkan overlay RTRW untuk memvalidasi kesesuaian rekomendasi teknis pemanfaatan ruang dengan rencana tata ruang wilayah.
            </p>
        </div>
        """, unsafe_allow_html=True)
    ...
    timeline_data = [
        ("1", "Pelajari Usaha Membuat NIB melalui OSS", "Permohonan Nomor Induk Berusaha melalui portal oss.go.id"),
        ("2", "Pendaftaran & Kelengkapi Dokumen", "Registrasi permohonan dan melengkapi seluruh dokumen yang dipersyaratkan"),
        ("3", "Eksposes Sekretariat & Disposisi Kepala Dinas", "Berkasmasuk ke sekretariat, kiriman dan disposisi Kepala Dinas"),
        ("4", "Disposisi Bidang Tata Ruang", "Kepala Dinas memberikan disposisi kepada Bidang Tata Ruang untuk ditindaklanjuti"),
        ("5", "Survei / Verifikasi Berkas", "Survey lapangan luas ± 5000m² - Verifikasi berkas luas ± 5000m²"),
        ("6", "Pengobahan Berkas", "Berkas diproses dan diolah saat studi teknis Bidang Tata Ruang"),
        ("7", "Proses Revisi & Persetujuan", "Draft rekomendasi dirisi dan dimintakan persetujuan internal"),
        ("8", "Verifikasi oleh Kepala Bidang", "Kepala Bidang melakukan telaah dan memberikan persetujuan"),
        ("9", "Proses ITD Kepala Bidang / Kepala Dinas", "Surat ditandatangani oleh Kepala Bidang atau Kepala Dinas sesuai kewenangan"),
        ("10", "Pertemuan Surat", "Surat rekomendasi teknis distribusi nomor registrasi dalam data sekretariat"),
